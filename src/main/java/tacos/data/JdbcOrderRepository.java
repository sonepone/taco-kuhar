...
public class JdbcOrderRepository implements OrderRepository {
	...
	public TacoOrder save(TacoOrder order) {
		...
		Object mojKey = keyHolder.getKeys().get("id");
		System.out.println("mojKey >" + mojKey + "<");
		System.out.println("mojKey klasa >" + mojKey.getClass() + "<");
		
		
		
		//long orderId = keyHolder.getKey().longValue();
		long orderId = ((Long)mojKey).longValue();
		order.setId(orderId);
	...
	private long saveTaco(Long orderId, int orderKey, Taco taco) {
		...
		System.out.println("mojKey >" + mojKey + "<");
		System.out.println("mojKey klasa >" + mojKey.getClass() + "<");
		long tacoId = ((Long)mojKey).longValue();
